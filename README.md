...
### 2) API 요청 인증 (JWT Verification)
  ...
  - **필터링**: JwtAuthenticationFilter에서 토큰의 유효성 및 만료 여부 검증
  - **인증 처리**: 검증 통과 시 SecurityContext에 인증 정보를 저장하여 API 접근 허용
...
- Recording과 Summary는 Consultation에 연결되어 “한 번의 진료에 대한 음성 + STT + 요약” 패키지 완성
